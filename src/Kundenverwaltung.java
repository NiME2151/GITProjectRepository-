...
public class Kundenverwaltung extends JFrame {
	...
	private void initGUI() {
		...
		contentPane.setLayout(null);
		{
			...
			}
			{
				...
				this.nachnameTextField.setBounds(120, 55, 190, 20);
			...
			}
			{
				...
				this.ibanTextField.setBounds(120, 80, 190, 20);
			...
			}
			{
				...
				this.emailTextField.setBounds(120, 105, 190, 20);
			...
			}
			{
				...
				this.telefonnummerTextField.setBounds(120, 130, 190, 20);
			...
			}
			{
				...
				this.adresseTextField.setBounds(120, 155, 190, 20);
	...
	public void actionPerformed(ActionEvent e) {
			...
			}
			{
				...
				this.kundendatenPanel.add(this.idLabel);
			}
			{
